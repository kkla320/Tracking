...
extension Analytics {
    ...
    public struct Event {
         ...
         */
        public private(set) var defaultMetadata: Metadata?
         ...
         */
        public init(name: String, defaultMetadata: Metadata? = nil) {
            self.name = name
...
extension Analytics.Event: ExpressibleByStringLiteral {
